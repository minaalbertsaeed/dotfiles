...
-- telescope map("n", "<leader>ff", "<cmd> Telescope find_files <CR>")
...
map('n', '<leader>0', '<Cmd>BufferLineGoToBuffer 1<CR>', { noremap = true, silent = true })
map('n', '<leader>1', '<Cmd>BufferLineGoToBuffer 2<CR>', { noremap = true, silent = true })
map('n', '<leader>2', '<Cmd>BufferLineGoToBuffer 3<CR>', { noremap = true, silent = true })
map('n', '<leader>3', '<Cmd>BufferLineGoToBuffer 4<CR>', { noremap = true, silent = true })
map('n', '<leader>4', '<Cmd>BufferLineGoToBuffer 5<CR>', { noremap = true, silent = true })
map('n', '<leader>5', '<Cmd>BufferLineGoToBuffer 6<CR>', { noremap = true, silent = true })
map('n', '<leader>6', '<Cmd>BufferLineGoToBuffer 7<CR>', { noremap = true, silent = true })
map('n', '<leader>7', '<Cmd>BufferLineGoToBuffer 8<CR>', { noremap = true, silent = true })
...
map('n', '<leader>tth', ':lua getTerminal("horizontal")<CR>', { noremap = true, silent = true })
map('n', '<leader>ttv', ':lua getTerminal("vertical")<CR>', { noremap = true, silent = true })
